    ...
    >
      ...
      <motion.div variants={fadeUp} className="flex justify-center pt-2 pb-4">
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="group relative w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-[#22D3EE] hover:bg-[#0891B2] text-white font-bold text-lg rounded-2xl px-14 py-4 transition-all duration-300 shadow-[0_4px_20px_rgba(34,211,238,0.3)] hover:shadow-[0_6px_28px_rgba(34,211,238,0.4)] cursor-pointer"
        >
          {t("letsGo")}
